...
describe Vodka::Lexer do
  it ".new" do
    lex = Vodka::Lexer.new "fortune |"

    # lex.tokens[0].to_s.should eq "[1:1] WORD `fortune`"
    # lex.tokens[1].to_s.should eq "[1:9] PIPE `|`"

    lex << "cowsay"

    # lex.tokens[2].to_s.should eq "[1:11] WORD `cowsay`"
